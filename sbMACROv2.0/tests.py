...
class Login(unittest.TestCase):
    ...
    def create_test_users(self):
        # Valid user
        user = User(username='susan_belinda7456789142',
...
class Registration(unittest.TestCase):
    ...
    def test_valid_user_registration(self):
        # Registration data
        data = {'username': 'admin2020',
                'email': 'admin123@gmail.com',
                'password': 'Admin@123', 'password2': 'Admin@123'}
    ...
    def test_invalid_email_registration(self):
        ...
        data = {'username': 'admin2020',
                'email': '', 'password': 'Admin@123', 'password2': 'Admin@123'}
        result = self.client.post('/register', data=data)
        assert result.status_code == 417
    ...
    def test_invalid_password1_password2_registration(self):
        ...
        data = {'username': 'admin2020',
                'email': 'admin123@gmail.com', 'password': '', 'password2': ''}
        result = self.client.post('/register', data=data)
        assert result.status_code == 417

    def test_invalid_password2fail_registration(self):
        # Registration data failure test
        # case for password compare functionality
        data = {'username': 'admin2020',
                'email': 'admin123@gmail.com',
                'password': 'Admin@123', 'password2': 'Admin@1234'}
        result = self.client.post('/register', data=data)
        assert result.status_code == 417

    def test_invalid_password1fail_registration(self):
        # Registration data 2nd failure test case for
        # password compare functionality
        data = {'username': 'admin2020',
                'email': 'admin123@gmail.com',
                'password': 'Admin@1234', 'password2': 'Admin@123'}
        result = self.client.post('/register', data=data)
        assert result.status_code == 417

    def test_invalid_password_requirement_registration(self):
        # Registration data requirement not matched in password field,
        # Atleast one speacial char and number should be included
        data = {'username': 'admin2020',
                'email': 'admin123@gmail.com',
                'password': 'Admin', 'password2': 'Admin@123'}
        result = self.client.post('/register', data=data)
        assert result.status_code == 417

    def test_invalid_password_requirement1_registration(self):
        # Registration data requirement not matched,
        # Atleast one char should be capital
        data = {'username': 'admin2020',
                'email': 'admin123@gmail.com',
                'password': 'admin@123', 'password2': 'admin@123'}
        result = self.client.post('/register', data=data)
    ...
    def test_invalid_password_requirement4_registration(self):
        ...
        data = {'username': 'admin2020',
                'email': 'admin123@gmail.com',
                'password': '_@#', 'password2': 'ADMIN@123'}
        result = self.client.post('/register', data=data)
        assert result.status_code == 417
    ...
    def test_invalid_password2_comparison2_registration(self):
        # Registration data equirement not matched,
        # no special character in password2
        data = {'username': 'admin2020',
                'email': 'admin123@gmail.com',
                'password': 'Admin@123', 'password2': 'Admin123'}
        result = self.client.post('/register', data=data)
        assert result.status_code == 417
    ...
    def test_invalid_password2_comparison4_registration(self):
        ...
        data = {'username': 'admin2020',
                'email': 'admin123@gmail.com',
                'password': 'Admin@123', 'password2': '_@#'}
        result = self.client.post('/register', data=data)
        assert result.status_code == 417
    ...
    def test_invalid_username_requirement2_registration(self):
        ...
        # required minmum 8 characters including 1 number
        data = {'username': 'a',
                'email': 'admin123@gmail.com',
                'password': 'Admin@123', 'password2': 'Admin@123'}
        result = self.client.post('/register', data=data)
    ...
    def test_invalid_username_requirement4_registration(self):
        # Registration data user requirement
        # not matched starting with _ is not allowed
        data = {'username': '_',
                'email': 'admin123@gmail.com',
                'password': 'Admin@123', 'password2': 'Admin@123'}
        result = self.client.post('/register', data=data)
    ...
    def test_invalid_email_requirement_registration(self):
        ...
        data = {'username': 'admin2020',
                'email': 'admin123', 'password': 'Admin', 'password2': 'Admin'}
        result = self.client.post('/register', data=data)
        assert result.status_code == 417
    ...
    def test_validemail_requirement_registration(self):
        ...
        data = {'username': '',
                'email': 'admin@gamail.com', 'password': '', 'password2': ''}
        result = self.client.post('/register', data=data)
        assert result.status_code == 417
    ...
    def test_validpassword_requirement_registration(self):
        ...
        data = {'username': '',
                'email': '', 'password': 'Admin@123', 'password2': ''}
        result = self.client.post('/register', data=data)
        assert result.status_code == 417

    def test_valid_compare_assword_requirement_registration(self):
        # Registration data with all blank field
        # except valid password and confirm password
        data = {'username': '',
    ...
    def test_bad_requirement_registration(self):
        ...
        data = {'username': '!23',
                'email': '##$@gamail.com',
                'password': '_dmin@123', 'password2': '9dmin@123'}
        result = self.client.post('/register', data=data)
        assert result.status_code == 417
...
class ResetPassword(unittest.TestCase):
    ...
    def test_valid_not_registered_email_reset(self):
        # valid Email data but not used at
        # the time of registration, BAD REQUEST
...
class EditProfileForm(unittest.TestCase):
    ...
    def test_valid_editProfile(self):
        ...
        data = {'username': 'Admin123',
                ...
                'password2': 'Admin@123', 'About': 'Testing Edit Profile page'}
    ...
    def test_valid_editProfile_option(self):
        ...
        data = {'username': 'Admin123',
                'email': 'admin@gmail.com',
                'password': 'Admin@123', 'password2': 'Admin@123', 'About': ''}
        result = self.client.post('/edit_profile', data=data)
        assert result.status_code == 302
