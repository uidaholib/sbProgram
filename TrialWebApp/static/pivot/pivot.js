...
var pivot = (function () {
    ...
    function appendField(field) {
        ...
        if (objectType(field) === 'string') field = {
            name: field
        };
    ...
    function addFieldValue(field, value) {
        ...
        if (fields[field].values[value] === undefined) {
            fields[field].values[value] = {
                count: 1,
                displayValue: fields[field].displayFunction(value, field)
            };
        } else {
