...
def index():
    ...
    #print(sort)
    NWCSC_FYs_OrderedDict2 = {}
    for i in sortNW:
        NWCSC_FYs_OrderedDict2.update({i: NWCSC_FYs_Dict[i]})
    NWCSC_FYs_OrderedDict = jsonify(NWCSC_FYs_OrderedDict2)
    ...
    #print(sort)
    SWCSC_FYs_OrderedDict2 = {}
    for i in sortSW:
        SWCSC_FYs_OrderedDict2.update({i: SWCSC_FYs_Dict[i]})
    SWCSC_FYs_OrderedDict = jsonify(SWCSC_FYs_OrderedDict2)
    print(SWCSC_FYs_OrderedDict)
    flash(SWCSC_FYs_OrderedDict)
    return(NWCSC_FYs_OrderedDict, SWCSC_FYs_OrderedDict)
    print("Now local?")
    print(NWCSC_FYs_OrderedDict)
    print(SWCSC_FYs_OrderedDict)
