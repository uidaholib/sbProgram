...
def parse_fiscal_years(fy_obj_list):
...
==============================================================================
            ...
            data_main.save_json(fiscal_year)
            if __debug__:
...
def get_csc_from_fy_id(sb_id):  # pylint: disable=R1710
...
def get_user_input_fys():
    ...
    while answer != 'done':
        ...
        if ((answer != 'done')
                and (answer != None)
                and (not data_main.id_in_list(fy_id_list, obj))
